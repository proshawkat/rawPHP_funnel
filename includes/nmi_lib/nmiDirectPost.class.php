...
class nmiDirectPost extends nmi
{
    ...
    {
        parent::__construct($nmi_url, $nmi_user, $nmi_password);
    }
   ...
   /* SHIPPING ADDRESS
    ...
    public function exe($amount, $vault_id){
        $query_string = "username=" . $this->nmi_user . "&password=" . $this->nmi_password . "&amount=".$amount."&customer_vault_id=".$vault_id;
        return parent::execute($query_string);   
    }
}